---
title: "Dinámica reciente de las remesas familiares en Nicaragua"
description: |
...
Otro aspecto a destacar es que un ingreso sostenido de remesas puede ser un desincentivo para el mercado laboral local. En este sentido, las familias receptoras tienen menos incentivos para entrar o permanecer dentro de la fuerza laboral, lo que tiene el potencial de reducir la capacidad productiva del país. Adicionalmente, se suma el efecto de la migración, que por un lado impulsa la entrada de remesas y, por el otro, reduce la fuerza laboral del país.

En ambos casos, las empresas pierden empleados productivos. Esto impacta negativamente índices de rotación de personal (los cuales aumentan) y se reduce la velocidad de contratación. Esta situación, que afecta especialmente alas que son intensivas en mano de obra, resulta en presiones sobre sus flujos de caja, debido a la reducción del capital de trabajo por el pago de indemnizaciones. También tienen efectos negativos sobre sus ganancias, debido a que se debe provisionar un mayor pasivo laboral.
